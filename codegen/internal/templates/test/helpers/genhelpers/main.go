...
func generateFile(packageName, outputDir, name, tmplPath string, registryImports []templates.Import) error {
	...
	// Register typesPrefix as an empty string — when helpers are embedded in the
	// same package, Date/DateFormat are unqualified.
	tmpl, err := template.New(name).Funcs(template.FuncMap{
		"typesPrefix": func() string { return "" },
	...
	// Include all registry imports — goimports will prune unused ones
