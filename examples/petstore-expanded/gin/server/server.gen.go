...
func (siw *ServerInterfaceWrapper) FindPets(c *gin.Context) {
	...
	err = BindFormQueryParam("tags", c.Request.URL.Query(), &params.Tags, ParameterOptions{ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "array", Format: ""})
	if err != nil {
	...
	err = BindFormQueryParam("limit", c.Request.URL.Query(), &params.Limit, ParameterOptions{ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "integer", Format: "int32"})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeletePet(c *gin.Context) {
	...
	err = BindSimpleParam("id", c.Param("id"), &id, ParameterOptions{ParamLocation: ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "int64"})
	if err != nil {
