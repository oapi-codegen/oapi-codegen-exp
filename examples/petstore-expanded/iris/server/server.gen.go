...
func (w *ServerInterfaceWrapper) FindPets(ctx iris.Context) {
	...
	err = BindFormQueryParam("tags", ctx.Request().URL.Query(), &params.Tags, ParameterOptions{ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "array", Format: ""})
	if err != nil {
	...
	err = BindFormQueryParam("limit", ctx.Request().URL.Query(), &params.Limit, ParameterOptions{ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "integer", Format: "int32"})
	if err != nil {
		ctx.StatusCode(http.StatusBadRequest)
...
func (w *ServerInterfaceWrapper) DeletePet(ctx iris.Context) {
	...
	err = BindSimpleParam("id", ctx.Params().Get("id"), &id, ParameterOptions{ParamLocation: ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "int64"})
	if err != nil {
		ctx.StatusCode(http.StatusBadRequest)
