...
func (siw *ServerInterfaceWrapper) FindPets(c fiber.Ctx) error {
	...
	err = BindFormQueryParam("tags", query, &params.Tags, ParameterOptions{ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "array", Format: ""})
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, fmt.Sprintf("Invalid format for parameter tags: %s", err))
	}

	// ------------- Optional query parameter "limit" -------------
	err = BindFormQueryParam("limit", query, &params.Limit, ParameterOptions{ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "integer", Format: "int32"})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeletePet(c fiber.Ctx) error {
	...
	err = BindSimpleParam("id", c.Params("id"), &id, ParameterOptions{ParamLocation: ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "int64"})
	if err != nil {
